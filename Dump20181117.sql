CREATE DATABASE  IF NOT EXISTS `dmd` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `dmd`;
...
INSERT INTO `payment` VALUES ('test111','220112');
...
CREATE TABLE `ride` (
  ...
  `DestinationPoint` varchar(45) DEFAULT NULL,
  `Distance` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`username`,`CID`,`Date`),
  KEY `CID_idx` (`CID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ride` VALUES ('test111','AN000',0,'113030','123040','22-09-2018','00x00x00','24x25x26','10');
...
CREATE TABLE `sockets` (
  ...
  `TimeToCharge` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-11-17 15:54:53
